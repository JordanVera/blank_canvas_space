    ...
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-20">
          <p className="text-[#C5A572] text-[10px] tracking-[0.4em] uppercase mb-4">Our Story</p>
      ...
      <section className="py-20 px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="flex flex-col gap-8">
          <h2 className="font-serif text-4xl sm:text-5xl leading-tight text-foreground">
            ...
            <em className="italic text-[#C5A572]">Webster, Texas.</em>
          </h2>
      ...
      <section className="py-20 px-6 lg:px-8 bg-[#F7F3ED]">

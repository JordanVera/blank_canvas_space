...
export const metadata: Metadata = {
  title: 'The Blank Canvas Space — Houston Event Venue',
  description:
    'All-inclusive intimate event venue in Webster, Texas. Bridal showers, baby showers, and celebrations for up to 65 guests.',
  keywords:
    'The Blank Canvas Space, event venue Webster TX, bridal shower venue Houston, baby shower venue Bay Area Houston',
  openGraph: {

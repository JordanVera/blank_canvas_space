    ...
    <>
      <section className="px-6 py-20 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl grid gap-8 lg:grid-cols-3">
          {VENUE_PACKAGES.map((pkg) => (
            ...
            >
              {pkg.highlighted ? (
                <span className="self-start bg-[#C5A572] px-3 py-1 text-[10px] tracking-[0.2em] uppercase text-black mb-4">
                  Most Popular
                </span>
              ) : null}
              ...
              <Link
                href="/contact"
                className="mt-8 inline-flex justify-center bg-[#C5A572] px-6 py-3 text-xs tracking-[0.2em] uppercase text-black hover:bg-[#D4B888] transition-colors"
              >
      ...
      <section className="px-6 py-16 lg:px-8 bg-[#0e0c08]">
        <div className="mx-auto max-w-7xl">
          <p className="text-[#C5A572] text-[10px] tracking-[0.35em] uppercase mb-4 text-center">
            Add-Ons
          </p>
          ...
          <div className="grid md:grid-cols-1 max-w-xl mx-auto">
            {ADD_ONS.map((addon) => (
              ...
              >
                <p className="font-serif text-4xl text-[#C5A572]">{addon.price}</p>
